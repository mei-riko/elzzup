...
(0, _jquery2.default)(document).ready(function () {
  ...
  function formatType(type) {
    ...
    var $type = (0, _jquery2.default)('<span><img src="' + baseUrl + '/' + type.element.value.toLowerCase() + '.svg" class="img-type" /> ' + type.text + '</span>');
    return $type;
  };
  if ((0, _jquery2.default)('#requestcustomerform-type_id').length > 0) {
    (0, _jquery2.default)('#requestcustomerform-type_id').select2({
      minimumResultsForSearch: -1,
      templateResult: formatType,
      theme: 'default select2-container--create'
    });
  };
  if ((0, _jquery2.default)('#requestcustomerform-city_id').length > 0) {
    (0, _jquery2.default)('#requestcustomerform-city_id').select2({
      theme: 'default select2-container--create'
    });
  };
  if ((0, _jquery2.default)('#requestcustomerform-language_id').length > 0) {
    (0, _jquery2.default)('#requestcustomerform-language_id').select2({
      theme: 'default select2-container--create'
    });
  };
  if ((0, _jquery2.default)('#requestcustomerform-reward_type').length > 0) {
    (0, _jquery2.default)('#requestcustomerform-reward_type').select2({
      minimumResultsForSearch: -1,
      theme: 'default select2-container--create'
    });
  };
